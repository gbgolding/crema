...
clf1 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model1.pkl'))
clf2 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model2.pkl')) 
clf3 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model3.pkl')) 
clf4 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model4.pkl')) 
clf5 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model5.pkl')) 
clf6 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model6.pkl')) 
clf7 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model7.pkl')) 
clf8 = joblib.load(os.path.join(CURRENT_DIR+'/../gb_models/model8.pkl')) 
